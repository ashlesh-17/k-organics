...
export default function Home() {
  const testimonials = [
    {
      ...
      text: "Absolutely divine incense that elevates my meditation practice.",
      rating: 5,
    },
    {
      name: "Rajesh Kumar",
      role: "Spiritual Guide",
      text: "Finally found authentic handmade incense that honors our traditions.",
      rating: 5,
    },
    {
      name: "Anjali Patel",
      role: "Wellness Enthusiast",
      text: "The craftsmanship is incredible. Made with such care and devotion!",
      rating: 5,
    },
  ];
  ...
  const whyUs = [
    ...
    },
    {
      ...
      description: "Each stick crafted with care",
    },
    {
    ...
    },
    {
      ...
      title: "Pure Heritage",
      description: "Indian tradition rooted",
    },
  ];
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 bg-gradient-to-br from-[#FFFCEF] via-[#F6E9D9] to-[#FFFCEF]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
            Premium handmade organic incense sticks rooted in Indian tradition.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover our finest handcrafted selections, each made with pure
              natural ingredients.
            </p>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Perfect gifts for Diwali, weddings, and spiritual occasions.
      ...
      <section className="py-16 md:py-24 px-4 bg-[#F6E9D9]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Discover the difference that handmade, organic incense can make.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/shop">
              <Button
